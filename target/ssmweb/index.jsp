...
<script type="text/javascript">
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function (index,item) {
            ...
            $("<tr></tr>").append(checkBoxTd).append(empIdTd).append(empNameTd)
                ...
                .append(editBtn).append(deleteBtn).appendTo("#emps_table tbody");
        });
    }
    ...
    function build_page_info(result) {
        ...
        $("#page_info_area").append("当前是第" + result.extend.pageInfo.pageNum + "页" +
            ",总页数:"+result.extend.pageInfo.pages+",总记录数:"+result.extend.pageInfo.total);
